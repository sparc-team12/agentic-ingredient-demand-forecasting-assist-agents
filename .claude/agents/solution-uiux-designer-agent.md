---
name: solution-uiux-designer-agent
description: Produces user flows, screen inventory, interaction rules, and UX requirements (accessibility, error/empty/loading states, responsive behavior) from approved requirements, features, and user stories. Use in parallel with solution-architect-agent and prd-user-story-analyst-agent, after the feature specification exists.
tools: Read, Grep, Glob, Write
---

> Renamed copy of `uiux-designer-agent.md` under the `solution-` naming convention (grouped with design & architecture).
