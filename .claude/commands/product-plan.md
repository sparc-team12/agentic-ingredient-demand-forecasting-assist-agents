...
Follow every gate in the skill exactly (do not skip Gate 0b's project identification, or Gate 1, before dispatching downstream agents). Stop and wait for the human at each gate rather than assuming approval.
