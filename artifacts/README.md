...
| `architecture/` | architecture-suite agents (`/generate-architecture`, a separate workflow from `orchestrator-agent`'s Gates 1-7) | `solution-architecture-overview.md`, `security-architecture.md`, `tech-stack.md`, `high-level-design.md`, `low-level-design.md`, and `architecture-validation.json`, coordinated by `solution-architecture-suite-orchestrator-agent` |
